...
const MobileRecordExpense = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!categoryId || !amount || !description || !paymentMethod || !paidBy) {
  ...
  return (
    <MobileContainer>
      <MobileHeader title="Record Expense" className="bg-destructive/90 text-destructive-foreground border-destructive" />

      <form onSubmit={handleSubmit} className="p-4 space-y-4 pb-24">
        <MobileFormField label="Expense Category" required>
        ...
        <MobileFormField label="Paid By" required>
          <Input
            value={paidBy}
...
export default MobileRecordExpense;
